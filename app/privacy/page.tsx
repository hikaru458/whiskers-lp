        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <section className="mb-12">
              ...
              <h3 className="text-lg font-medium mb-2 text-gray-800">（3）企業が提供する情報</h3>
              <ul className="list-disc list-inside space-y-1 text-gray-700 mb-6">
                <li>企業名・担当者名</li>
                <li>連絡先（メールアドレス等）</li>
                <li>コンテスト情報・依頼内容</li>
              ...
              <h3 className="text-lg font-medium mb-2 text-gray-800">（4）利用状況に関する情報</h3>
              <ul className="list-disc list-inside space-y-1 text-gray-700 mb-6">
                <li>IPアドレス</li>
                <li>Cookie</li>
                <li>端末情報</li>
              ...
              <h3 className="text-lg font-medium mb-2 text-gray-800">（5）決済情報</h3>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">初回アクセス時にCookieバナーを表示し、「同意する／拒否する」を選択できるようにします。拒否した場合、一部機能が利用できない場合があります。</p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">これらのサービスは海外（特に米国）にサーバーを持つ場合があり、個人情報が外国に移転される可能性があります。当サービスは、個情法24条に基づき、適切な保護措置を講じています。</p>
            </section>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="py-3 px-4 text-gray-900">情報の種類</th>
                      <th className="py-3 px-4 text-gray-900">保存期間</th>
                    </tr>
                  </thead>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-500 mt-4 text-sm">■ 対応期限：本人確認後、原則30日以内に対応します。</p>
            </section>
